...
export function AppFooter({ onNavigateToPlanner }: AppFooterProps) {
          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex justify-center md:justify-start gap-4">
              ...
              <a
                ...
                className="w-10 h-10 flex items-center justify-center rounded-lg bg-gray-800 hover:bg-blue-600 text-gray-400 hover:text-white transition-all durée-300 hover:scale-110"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
              >
